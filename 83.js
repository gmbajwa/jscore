 ...
 */
    ...
    createUsers.prototype.is18 = function() { return this.age > 18}
    createUsers.prototype.sing = function() { return 'la la la la la la la'}
...
function createUsers(id, fName, lName, cast, gender, age, address) {
    ...
    const user = Object.create(createUsers.prototype) // creating empty object, and proto chaining
